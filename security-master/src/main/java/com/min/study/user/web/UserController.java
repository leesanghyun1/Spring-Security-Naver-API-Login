...
public class UserController {
	...
	public String insertUser(@RequestParam("id")String id, @RequestParam("password")String password, @RequestParam("authority")String authority,@RequestParam("name")String name){
		String dbpw = encoder.saltEncoding(password, id); //사용자 가입시 비밀번호 암호화
